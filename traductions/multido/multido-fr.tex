...
\title{L'extension \textsf{multido}\thanks{Ce fichier a pour numéro de 
       version \fileversion\ et a été mis à jour le 14/10/2010. Son titre 
       original est \og \emph{Documentation for multido.tex, version \MDfv.
       A loop macro for Generic \protect\TeX} \fg.}\\[2pt] Une commande de
       boucle pour \TeX}
\author{Timothy Van Zandt%
  \thanks{Adresse de l'auteur : Department of Economics, Princeton
   University, Princeton, NJ 08544-1021, USA. Internet: 
   \protect\url{tvz@Princeton.EDU}. Ce document a été édité par Rolf
   Niepraschk \protect\url{Rolf.Niepraschk@gmx.de} et Herbert Voss 
   \protect\url{hvoss@tug.org} pour le rendre compilable avec LaTeX2e
   (2006-01-01)}}
\date{14/05/2010}
\maketitle
