...
\title{\bfseries Les extensions \tikzname\ et {\Large PGF}\\
  \large Manuel de la version \pgfversion\\[1mm]
\large\href{http://sourceforge.net/projects/pgf}{\texttt{http://sourceforge.net/projects/pgf}}}
\author{Till Tantau\footnote{Editeur de cette documentation. Certaines parties
    de cette documentation ont été écrites par d'autre auteurs comme indiqué
    dans ces parties ou chapitres et en section~\ref{section-authors}.}\\
  \normalsize Institut d'informatique théorique\\[-1mm]
  \normalsize Université de Lübeck}
...
\include{pgfmanual-fr-introduction}


\part{Tutoriels et lignes de conduite}
...
\include{pgfmanual-fr-tutorial}
\include{pgfmanual-fr-tutorial-nodes}
\include{pgfmanual-fr-tutorial-Euclid}
\include{pgfmanual-fr-tutorial-chains}
\include{pgfmanual-fr-tutorial-map}
\include{pgfmanual-fr-guidelines}
...
\include{pgfmanual-fr-installation}
\include{pgfmanual-fr-license}
\include{pgfmanual-fr-drivers}
...
\include{pgfmanual-fr-tikz-design}
\include{pgfmanual-fr-tikz-scopes}
\include{pgfmanual-fr-tikz-coordinates}
\include{pgfmanual-fr-tikz-paths}
\include{pgfmanual-fr-tikz-actions}
\include{pgfmanual-fr-tikz-arrows}
\include{pgfmanual-fr-tikz-shapes}
\include{pgfmanual-fr-tikz-pics}
\include{pgfmanual-fr-tikz-graphs}
\include{pgfmanual-fr-tikz-matrices}
\include{pgfmanual-fr-tikz-trees}
\include{pgfmanual-fr-tikz-plots}
\include{pgfmanual-fr-tikz-transparency}
\include{pgfmanual-fr-tikz-decorations}
\include{pgfmanual-fr-tikz-transformations}
...
\include{pgfmanual-fr-gd-overview}
\include{pgfmanual-fr-gd-usage-tikz}
\include{pgfmanual-fr-gd-usage-pgf}
\include{pgfmanual-fr-gd-trees}
\include{pgfmanual-fr-gd-layered}
\include{pgfmanual-fr-gd-force}
\include{pgfmanual-fr-gd-circular}
\include{pgfmanual-fr-gd-phylogenetics}
\include{pgfmanual-fr-gd-edge-routing}
%
% XXX : disabled because of 
% 1. compile-time dependencies which are hard to resolve
% 2. it is "hardly usable anyway" (TT)
%\include{pgfmanual-fr-gd-ogdf}
\include{pgfmanual-fr-gd-algorithm-layer}
\include{pgfmanual-fr-gd-algorithms-in-c}
\include{pgfmanual-fr-gd-display-layer}
\include{pgfmanual-fr-gd-binding-layer}
...
\include{pgfmanual-fr-library-angles}
\include{pgfmanual-fr-library-arrows}
\include{pgfmanual-fr-library-automata}
\include{pgfmanual-fr-library-babel}
\include{pgfmanual-fr-library-backgrounds}
\include{pgfmanual-fr-library-calc}
\include{pgfmanual-fr-library-calendar}
\include{pgfmanual-fr-library-chains}
\include{pgfmanual-fr-library-circuits}
\include{pgfmanual-fr-library-decorations}
\include{pgfmanual-fr-library-er}
\include{pgfmanual-fr-library-external}
\include{pgfmanual-fr-library-fadings}
\include{pgfmanual-fr-library-fit}
\include{pgfmanual-fr-library-fixedpoint}
\include{pgfmanual-fr-library-fpu}
\include{pgfmanual-fr-library-lsystems}
\include{pgfmanual-fr-library-math}
\include{pgfmanual-fr-library-matrices}
\include{pgfmanual-fr-library-mindmaps}
\include{pgfmanual-fr-library-folding}
\include{pgfmanual-fr-library-patterns}
\include{pgfmanual-fr-library-petri}
\include{pgfmanual-fr-library-plot-handlers}
\include{pgfmanual-fr-library-plot-marks}
\include{pgfmanual-fr-library-profiler}
\include{pgfmanual-fr-library-shadings}
\include{pgfmanual-fr-library-shadows}
\include{pgfmanual-fr-library-shapes}
\include{pgfmanual-fr-library-spy}
\include{pgfmanual-fr-library-svg-path}
\include{pgfmanual-fr-library-edges}
\include{pgfmanual-fr-library-through}
\include{pgfmanual-fr-library-trees}
\include{pgfmanual-fr-library-turtle}
...
\include{pgfmanual-fr-pgfkeys}
\include{pgfmanual-fr-pgffor}
\include{pgfmanual-fr-pgfcalendar}
\include{pgfmanual-fr-pages}
\include{pgfmanual-fr-xxcolor}
\include{pgfmanual-fr-module-parser}
...
\include{pgfmanual-fr-math-design}
\include{pgfmanual-fr-math-parsing}
\include{pgfmanual-fr-math-commands}
\include{pgfmanual-fr-math-algorithms}
\include{pgfmanual-fr-math-numberprinting}
\include{pgfmanual-fr-oo}
...
\include{pgfmanual-fr-base-design}
\include{pgfmanual-fr-base-scopes}
\include{pgfmanual-fr-base-points}
\include{pgfmanual-fr-base-paths}
\include{pgfmanual-fr-base-decorations}
\include{pgfmanual-fr-base-actions}
\include{pgfmanual-fr-base-arrows}
\include{pgfmanual-fr-base-nodes}
\include{pgfmanual-fr-base-matrices}
\include{pgfmanual-fr-base-transformations}
\include{pgfmanual-fr-base-patterns}
\include{pgfmanual-fr-base-images}
\include{pgfmanual-fr-base-external}
\include{pgfmanual-fr-base-plots}
\include{pgfmanual-fr-base-layers}
\include{pgfmanual-fr-base-shadings}
\include{pgfmanual-fr-base-transparency}
\include{pgfmanual-fr-base-internalregisters}
\include{pgfmanual-fr-base-quick}
...
\include{pgfmanual-fr-pgfsys-overview}
\include{pgfmanual-fr-pgfsys-commands}
\include{pgfmanual-fr-pgfsys-paths}
\include{pgfmanual-fr-pgfsys-protocol}
