...
% TransLaTeX : for the french version
\usepackage[french]{babel}
\usepackage{translatex-fr}
% End
...
%  \usepackage{luatextra}
  ...
  % pgfmanual-fr-macros.tex defines an environment named filedescription
...
\input{../../macros/pgfmanual-fr-macros}    % TODOsp: same here
...
%\includeonly{pgfmanual-fr-library-profiler}
