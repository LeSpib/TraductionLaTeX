...
\usepackage[inputenc,fontenc,babel]{translatex-fr} % avec modification de \no  en \non pour éviter un problème avec babel.
...
\DeleteShortVerb{\|}
 ...
 \title{L'extension glossaries \\ Manuel utilisateur v4.25}
...
\begin{abstract}
L'extension \styfmt{glossaries} fournit un moyen de définir des termes, 
abréviations ou symboles qui peuvent être référencés au sein de votre document.
Des listes triés avec les \glslink{entrylocation}{localisations} associées
peuvent être générées soit avec \TeX, soit avec une \gls{indexingapp}
complémentaire.

Des fonctionnalités additionnelles non fournies ici sont disponibles à travers
l'extension \gls{glossaries-extra} qui, si besoin est, doit être installée
séparément. De nouvelles fonctionnalités y seront ajoutées. Les version de
l'extension \styfmt{glossaries} après la version v4.21 sont essentiellement 
