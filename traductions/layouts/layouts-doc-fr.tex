...
\title{L'extension \textsf{layouts}\thanks{Ce fichier n'a pas de numéro de
       version mais a été mis à jour en octobre 2004. Son 
       titre original est \og \emph{The \file{layouts} package: User 
       manual} \fg.} \\ Manuel utilisateur}
\author{
  Auteur : Peter Wilson, Herries Press \\
  Mainteneur : Will Robertson \\
  \texttt{will dot robertson at latex-project dot org}
}
\date{Octobre 2004\thanks{Les versions antérieures sont datés de 
      novembre 2003, Juillet 2002, mars 2002, novembrer 2001, juillet 2001
      et janvier 1999.}}
...
\maketitle
\begin{abstract}
    L'extension \textsf{layouts} de \LaTeX{} permet d'afficher les
différents éléments de la mise en page d'un document. Ces éléments
comprennent le positionnement du texte sur une page, la disposition
des flottants sur une page, la mise en page géométrique des listes et
des notes de base de page, la présentation des titres de division du
documnet et leur mise en page dans la table des matières. Il permet
également aux concepteurs de documents d'expérimenter des mises en
page.
\end{abstract}
\tableofcontents
\listoftables
