...
\def\thispackage{l'extension \package{caption}}
\def\Thispackage{L'extension \package{caption}}
...
\title{L'extension \textsf{caption}\thanks{Ce fichier a pour numéro de
        version \fileversion\ et a été mis à jour le \filedatefr. Son 
        titre original est \og \emph{Customizing captions of floating
        environments} \fg.} \\ Personnalisation des légendes de flottants}
...
\begin{abstract}
\Thispackage\ permet de personnaliser les légendes de flottants comme |figure|
et |table| et coopère avec de nombreuses autres extensions.
\par\smallskip
\textit{Note :} de nombreuses classes de document disposent déjà d'options
et de commandes internes pour personnaliser les légendes.
Si ces possibilités vous suffisent, vous n'avez en général pas à vous servir
de \thispackage.
Et si vous êtes juste intéressés par la commande \cs{captionof}, le chargement
de la très petite extension \package{capt-of} est normalement suffisant.
\end{abstract}
