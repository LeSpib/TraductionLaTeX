...
\makeatother
\def\fileversion{2012-11}
\def\filedatefr{07/11/2012}
\title{L'extension \textsf{hyperref}\thanks{Ce fichier a pour numéro de
        version \fileversion\ et a été mis à jour le \filedatefr. Son 
        titre original est \og \emph{Hypertext marks in \hologo{LaTeX} : a 
        manual for \xpackage{hyperref}} \fg.} \\ Manuel d'utilisation}
