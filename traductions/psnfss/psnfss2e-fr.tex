...
\title{La collection \textsf{PSNFSS}\thanks{Ce fichier a pour numéro de
       version 9.2 et a été mis à jour le 15/09/2004. Son titre original
       est \og \emph{Using common \ps\ fonts with \LaTeX} \fg.} \\
       Utilisation de polices \ps\ courantes avec \LaTeX}
...
\hypersetup{pdfauthor={Walter Schmidt},
            pdftitle={La collection PSNFSS},
            pdfsubject={PSNFSS v9.2},
            pdfkeywords={LaTeX PSNFSS polices PostScript}}
