...
\begin{document}
  ...
  \chapter{Package description}
    \lettrine[findent=0.2em,nindent=0em,realheight=true]{T}{he} package \textsl{fncychap} has been written such that
  ...
  \lettrine[findent=0.2em,nindent=0em,realheight=true]{A}{}part from the chapter styles, some additional commands are
