...
\begin{document}
  ...
  \chapter{Aperçu des styles de chapitre}
    ...
    \emph{ZERO} à \emph{NINETYNINE}\footnote{N.D.T. : voir l'annexe 
    ...
    \begin{figure}[h]
      \begin{minipage}{7 cm}
        \label{fig:Sonnys}
        \centerline{\color{gray!25}\fbox{\includegraphics[height=6cm]{Sonnys.eps}}} 
    ...
    \begin{figure}[h]
      \begin{minipage}{7 cm}
        \centerline{\color{gray!25}\fbox{\includegraphics[height=6cm]{Lennys.eps}}} 
    ...
    \begin{figure}[h]
      \begin{minipage}{7 cm}
        \centerline{\color{gray!25}\fbox{\includegraphics[height=6cm]{Rejnes.eps}}}
    ...
    \begin{figure}[h]
      ...
      \end{minipage}\hfill
      \begin{minipage}{7 cm}
        \centerline{\color{gray!25}\fbox{\includegraphics[height=6cm]{Bjarne.eps}}}
    ...
    \begin{figure}[h]
      \begin{minipage}{7 cm}
        \centerline{\color{gray!25}\fbox{\includegraphics[height=6cm]{Bjornstrups.eps}}} 
  ...
  \chapter{Exemple simple}
    ...
    document en les encadrant avec les commandes \A{makeatletter} et 
    ...
    respectivement. Finalement, les fonctions \A{FmN}\{ \} pour le nom et
