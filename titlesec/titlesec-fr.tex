...
avec un groupe; Sinon le *leading* pourrait être faux --- trop grand ou trop 
...
valeur négative, le titre *overhangs* \footnote{Ce paramètre n'est pas 
...
extensibilité et une infime compressabilité. Dans le |<sep-après>|, une 
certaine extensibilité (plus petite) et aucun compressabilité\footnote{Ils
