...
\section[Appendix]{Ceci est un exemple de la commande de section définie ci-dessous et, je dirais même plus, ceci est un exemple de la commande de section définie ci-dessous}
...
\section[Appendix]{Un titre encadré}
...
\section[Appendix]{Un titre avec filet horizontal}
...
\section[Appendix]{Un autre titre avec filet horizontal}
...
\section[Appendix]{La largeur du filet ci-dessus est celle de la
  plus longue ligne de ce titre augmentée de deux picas}

\leavevmode

\section[Appendix]{Celui-ci est plus court}
...
\section[Appendix]{Ceci est un exemple de la commande de section définie ci-dessous 
...
\section[Appendix]{Un exemple simple d'une forme \og wrap \fg{} sur une section}
...
\section[Appendix]{Un titre attaché à l'ancienne}

Bien sûr, vous pourriez préférer un point après le titre. Dans ce cas, l'argument
