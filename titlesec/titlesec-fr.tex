...
\titlecontents*{subsection}[1.5em]
  ...
  [.---][.]
\end{verbatim}
dont le résultat est affiché dans la table des matières en tout début
de ce document. Notez que la mise en forme du paragraphe doit être 
écrite dans l'argument |<code-dessus>|.

\tradini Let us explain how the optional arguments works.  First note the number
