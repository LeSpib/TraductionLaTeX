...
\verb|openany|). Ainsi, vous pouvez contourner \verb|openright| en définissant
\verb|\chapterbreak| comme \verb|\clearpage|, du moment que sa classe a été 
changée en \verb|top| (dans cet exemple, les parties conserveront le 
paramétrage \verb|openright|).
